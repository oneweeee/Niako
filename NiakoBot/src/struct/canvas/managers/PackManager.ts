...
export interface IPackResolveConfig { background: string, activeUserUpdated: string, items: any[], status: string, backgrounds: { [key: string]: string } }
...
export default class PackManager {
    ...
    private getLiteConfig(styles: 'Pink' | 'Blue' | 'Red' | 'Purple' | 'Green' | 'Yellow'): IPackConfig {
        return {
            ...
            styles: [
                {
                    background: 'LitePack_Blue',
                    active: true
                },
                {
                    background: 'LitePack_Green',
                    active: true
                },
                {
                    background: 'LitePack_Pink',
                    active: true
                },
                {
                    background: 'LitePack_Purple',
                    active: true
                },
                {
                    background: 'LitePack_Red',
                    active: true
                },
                {
                    background: 'LitePack_Yellow',
                    active: true
                }
            ]
        }
    ...
    private getTechnologieConfig(styles: 'Pink' | 'Blue' | 'Red' | 'Purple' | 'Green' | 'Yellow'): IPackConfig {
        return {
            ...
            styles: [
                {
                    background: 'TechnologiePack_Blue',
                    active: true
                },
                {
                    background: 'TechnologiePack_Green',
                    active: true
                },
                {
                    background: 'TechnologiePack_Pink',
                    active: true
                },
                {
                    background: 'TechnologiePack_Purple',
                    active: true
                },
                {
                    background: 'TechnologiePack_Red',
                    active: true
                },
                {
                    background: 'TechnologiePack_Yellow',
                    active: true
                }
            ]
        }
    ...
    private getAvenueConfig(styles: 'Pink' | 'Blue' | 'Red' | 'Purple' | 'Green' | 'Yellow'): IPackConfig {
        return {
            ...
            styles: [
                {
                    background: 'AvenuePack_Blue',
                    active: true
                },
                {
                    background: 'AvenuePack_Green',
                    active: true
                },
                {
                    background: 'AvenuePack_Pink',
                    active: true
                },
                {
                    background: 'AvenuePack_Purple',
                    active: true
                },
                {
                    background: 'AvenuePack_Red',
                    active: true
                },
                {
                    background: 'AvenuePack_Yellow',
                    active: true
                }
            ]
        }
    ...
    private getSpaceConfig(): IPackConfig {
        return {
            ...
            styles: [
                {
                    background: 'SpacePack_Blue',
                    active: true
                },
                {
                    background: 'SpacePack_Green',
                    active: true },
                {
                    background: 'SpacePack_Pink',
                    active: true
                },
                {
                    background: 'SpacePack_Purple',
                    active: true
                },
                {
                    background: 'SpacePack_Red',
                    active: true
                },
                {
                    background: 'SpacePack_Yellow',
                    active: true
                }
            ]
        }
